...
#> wrote /var/folders/yd/5vhpvlls31x18db51sk7y_zh0000gn/T//RtmpFlko8C/file6d3c7d86b74f.R - run it once, then join probe_coords.csv to your probes. Lighter: dmsa_probe_coords(), or skip coordinates entirely.
