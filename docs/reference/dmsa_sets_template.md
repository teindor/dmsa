...
#> wrote /var/folders/yd/5vhpvlls31x18db51sk7y_zh0000gn/T//RtmpwVOFZ5/file620973dafc64.csv and /var/folders/yd/5vhpvlls31x18db51sk7y_zh0000gn/T//RtmpwVOFZ5/file620973dafc64.md

## the .md alongside it states the rules the validator enforces
basename(c(p, sub("\\.csv$", ".md", p)))
#> [1] "file620973dafc64.csv" "file620973dafc64.md" 
